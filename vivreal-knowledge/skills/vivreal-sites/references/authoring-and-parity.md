...
- The left rail is drag-resizable (300 to 600px, persisted to `localStorage studio_rail_width`); the portal sidebar is hidden on `/sites/studio`; desktop preview fills containers >1440px at native width.
