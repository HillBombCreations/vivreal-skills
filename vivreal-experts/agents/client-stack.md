...
Last extended: 2026-09-08 (release 2, walks 7 to 10, and the ordering investigation)
...
- **Live versions as of 2026-09-08:** `VR_Client_API` **v2.8.1**, `VR_CMS_API` v2.7.2, `VR_Secure_API` v2.10.1, portal v0.18.0, Templates `stable` `07bd687`, renderer 1.68.0 (walk 10 section 1, each read off the deployed artifact).
