...
1. **Count claims**: Secure Lambda roster (15 @ 2026-08-15), portal proxy-route count (198 = 167 factory + 31 manual @ 2026-08-15 — classify by the `_helpers/createProxyHandler` module path, not a string grep), MCP tool counts (69 CMS / 50 outreach), Main Lambda count (4), Outreach (4), EventHandler (27 = 12+9+6), renderer version (1.50.0 @ 2026-08-15), schemas (1.29.0), tier-quotas (3.1.0) — grep the skills repo for the numbers and re-verify against source.
