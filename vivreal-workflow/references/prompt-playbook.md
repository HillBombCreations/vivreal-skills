...
> First research how similar things work today in **[repo/area]**, then design 2 to 3 approaches with tradeoffs and recommend one. Once I approve the design, implement it following existing conventions, add tests, and self-review before reporting done.
...
| `/design` | Architecture decision, 2 to 3 options with tradeoffs + recommendation |
