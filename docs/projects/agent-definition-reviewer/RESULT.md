...
*default*, settable via `CLAUDE_CODE_MAX_SUBAGENT_SPAWN_DEPTH`, and was `5` in v2.1.172 to 216 and
`1` in v2.1.217 to 218, so the eval asserts the behavior, not the integer.
